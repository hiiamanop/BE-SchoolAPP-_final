...
@section('content')
                   ...
                   <div class="modal-dialog">
                       <div class="modal-content">
                           ...
                           <div class="modal-body">
                               <form action="{{ route('guru_pelajarans.import') }}" method="POST" enctype="multipart/form-data">
                                   @csrf
                                   <div class="mb-3">
                            ...
                            <tbody>
                                @foreach ($guruPelajarans as $index => $guruPelajaran)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $guruPelajaran->mataPelajaran->name }}</p>
                                        </td>
                                        <td class="align-middle text-center">
                                            <!-- Edit Button -->
                                            <button type="button" class="text-secondary font-weight-bold text-xs btn btn-link"
                                                data-bs-toggle="modal" data-bs-target="#editGuruPelajaranModal{{ $guruPelajaran->id }}">
                                                Edit
                                            </button>

                                            <!-- Delete Button -->
                                            <form action="{{ route('guru_pelajarans.destroy', $guruPelajaran->id) }}" method="POST"
                                    ...
                                    <div class="modal fade" id="editGuruPelajaranModal{{ $guruPelajaran->id }}" tabindex="-1"
                                        aria-labelledby="editGuruPelajaranModalLabel{{ $guruPelajaran->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editGuruPelajaranModalLabel{{ $guruPelajaran->id }}">
                                                ...
                                                <div class="modal-body">
                                                    <form id="editGuruPelajaranForm{{ $guruPelajaran->id }}"
                                                        action="{{ route('guru_pelajarans.update', $guruPelajaran->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-3">
                                                            <label for="guru{{ $guruPelajaran->id }}" class="form-label">Guru</label>
                                                            <select class="form-select" id="guru{{ $guruPelajaran->id }}" name="guru_id" required>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="mataPelajaran{{ $guruPelajaran->id }}" class="form-label">Mata Pelajaran</label>
                                                            <select class="form-select" id="mataPelajaran{{ $guruPelajaran->id }}"
                                                        ...
                                                        <div class="text-center">
                                                            <button type="submit" class="btn btn-primary">Update Guru Mata Pelajaran</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="addGuruPelajaranModal" tabindex="-1" aria-labelledby="addGuruPelajaranModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
