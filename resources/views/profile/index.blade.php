            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/person1.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ $user->role_id == 1 ? 'Admin' : ($user->role_id == 2 ? 'Guru' : 'No Role') }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 ps-0 text-sm">
                                <strong class="text-dark">Nomor Induk:</strong> &nbsp; {{ $user->nomor_induk }}
                                <!-- Adjust as needed -->
                            </li>
                            <li class="list-group-item border-0 ps-0 text-sm">
